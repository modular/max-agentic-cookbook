...
**Endpoint:** `POST /api/recipes/image-captioning`
...
NDJSON (Newline-Delimited JSON) stream with progressive results:

```json
{"imageId": "img-1", "text": "A scenic mountain landscape...", "ttft": 234, "duration": 567}
{"imageId": "img-2", "text": "A city skyline at sunset...", "ttft": 189, "duration": 423}
```
