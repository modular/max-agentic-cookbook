...
2. Backend converts UIMessage → OpenAI format:
...
**Endpoint:** `POST /api/recipes/multiturn-chat`
...
data: {"type": "text-delta", "id": "msg-2", "delta": "Hello"}

data: {"type": "text-delta", "id": "msg-2", "delta": "!"}
...
**Get Source Code:** `GET /api/recipes/multiturn-chat/code`
